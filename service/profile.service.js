(() => {
    window.angular.module('blogApp').factory('profileService', function($http) {
        let baseURL = 'https://conduit.productionready.io/api';
        let header = {
            headers: {
                Authorization:
                    'Token eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpZCI6NDI3NjUsInVzZXJuYW1lIjoiSlFLQTIiLCJleHAiOjE1NDg0MTA2NjZ9.GCKLhh7qucQNXDrTLc6FW49B97ShggYjNe3U70-hRRM',
            },
        };
        let service = {
