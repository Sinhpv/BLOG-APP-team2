    ...
    angular
        ...
        .config(function($stateProvider, $urlRouterProvider) {
            let authState = {
                    ...
                    abstract: true,
                    resolve: {
                        isAuth: function(AuthService, ArticlesService, profileService, appService) {
                        ...
                        user : function(AuthService) {
                            return AuthService.getUserInfo().catch(()=>{return {username: ''};});
                        }
                    },
                ...
                articleState = {
                    ...
                    controller: function(appService, $scope,isAuth,user, $stateParams, $state) {
                                ...
                                if (username === $scope.username) {
                                    ...
                                    $scope.deleteArticle = function() {
                                        appService
                                            ...
                                            .then(() => {
                                                $state.go('profiles', {username: $scope.username });
                                            });
                                    };
                                        ...
                                        .then((user) => {
                                            if (user.data.profile.following) {
                                                appService
                                                    ...
                                                    .then((profile) => {
                                                        $scope.isFollow = !profile.data
                                                            .profile.following;
                                                    });
                                            } else {
                                                appService
                                                    .follow(user.data.profile.username)
                                                    .then((profile) => {
                                                        $scope.isFollow = !profile.data
                                                            .profile.following;
                                                    });
